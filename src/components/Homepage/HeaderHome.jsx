 ...
 export default function HeaderHome() {
  ...
  return (
    ...
    <div className="flex flex-col px-8 md:px-20">
      {/* Container Pertama */}
      <div className="flex flex-row justify-center items-center gap-x-4 md:gap-x-16 pt-14">
        <img src={FonRend} alt='Font' className='h-16 md:h-40'/>
        <img src={imageRight} alt='ImgRight' className='h-16 md:h-36'/>
      </div>

      <div className='flex flex-row justify-center items-center gap-x-5 md:gap-x-14 md:pl-12 pt-4'>
        {/* Container Kedua */}
        <div>
          <img src={Plate} alt='Plate' className='h-24 md:h-52'/>
        </div>
