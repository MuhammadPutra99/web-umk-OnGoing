...
export default function BodyHomeThree() {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-10">
      {/* ELEMENT TOP */}
      <div className="flex flex-row justify-center px-24 pb-12">
        {/* LEFT */}
        <div className="w-1/2 flex flex-col">
          <p className="montserrat text-4xl text-black font-bold">Butuh bantuan? Hubungi Kami!</p>
          <p className="montserrat text-lg text-slate-500 font-semibold text-justify pr-32 pt-2">{descTitle}</p>
        </div>
